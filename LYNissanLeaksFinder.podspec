...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/OuyangMumu/LYNissanLeaksFinder'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'OuyangMumu' => 'ouyanggj@szlanyou.com' }
  s.source           = { :git => 'https://github.com/OuyangMumu/LYNissanLeaksFinder.git', :tag => s.version.to_s }
